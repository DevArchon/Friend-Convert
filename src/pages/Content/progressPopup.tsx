...
#FCE_friend_convert_model .section{background:white;box-shadow: 0px 10px 36px rgba(0, 0, 0, 0.130709);border-radius: 14px;font-family:Arial, Helvetica, sans-serif;}
#FCE_friend_convert_model .icon{width:100%;text-align:center !important;padding-top:5%;}
#FCE_friend_convert_model .text{width:100%;text-align:center !important;width:100%;font-size: 20px !important;line-height: 23px;color: #000000;margin-top:7%}
#FCE_friend_convert_model .text h3{font-size: 20px !important; padding: 0 10px !important;}
#FCE_friend_convert_model .text h2{text-align:center !important;width:100%;font-size: 24px !important;line-height: 23px;color: #333333;margin-top:5%}
#FCE_friend_convert_model .block{width:100%;font-size: 25px !important;line-height: 18px;text-align: center;color: #000000;margin-top: 9%;font-weight: bold;}
...
#FCE_friend_convert_model #text h2{margin-top:3%;font-size:16px !important;margin-bottom:3%}
#friend-convert-msgs{
  padding-bottom: 20px;
}
...
function mountProgressPopup() {
  ...
  if (!container) {
    ...
    container.innerHTML = `
      <div class="section">
        <a id="FCE_close_btn" href="#">&times;</a>
        <div class="icon">
          <img src="${icon34}" alt="progress" />
        </div>
        <div class="text">
          <h3 id="FCE_status">Idle</h3>
          <h2><span id="FCE_sent">0</span> / Limit: <span id="FCE_limit">0</span></h2>
          <div id="FCE_scanning">Scanning...</div>
          <div id="FCE_paused" style="display:none;color:#ff9800;font-weight:600;">Paused</div>
          <div class="block">
            Total Members<br />
            <span id="FCE_total">0</span>
          </div>
        </div>
